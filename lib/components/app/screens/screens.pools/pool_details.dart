...
import 'package:grupchat/components/app/screens/widgets/pools/bordered_button.dart';
...
import 'package:grupchat/components/app/screens/widgets/transactions/transactions_section.dart';
...
class _PoolDetailsState extends State<PoolDetails> {
  ...
  Future<void> deletePool() async {
    try {
      ...
      await _dataService.deletePool(widget.poolId);
      if (mounted) {
